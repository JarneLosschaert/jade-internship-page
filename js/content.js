...
const SITE = {
  ...
  stories: [
    ...
    /* ===== 3. DIGITAL PRODUCT PASSPORT ================================= */
    {
      ...
      cover: "images/digital-product-passport/cover.jpeg",
      frame: "polaroid",
      accent: "red",
      blocks: [
        { heading: "Professional skill", text:
      ...
      gallery: [
        { src: "images/digital-product-passport/label-2.jpeg", caption: "Physical label design" },
        { src: "images/digital-product-passport/label-3.jpeg", caption: "Physical label design" },
        { src: "images/digital-product-passport/label-4a.jpeg", caption: "Label variation" },
        { src: "images/digital-product-passport/label-1b.jpeg", caption: "Label variation" },
        { src: "images/digital-product-passport/screenshot-1.png", caption: "Designing the passport in Figma" },
        { src: "images/digital-product-passport/screenshot-3.png", caption: "Designing the passport in Figma" },
        { src: "images/digital-product-passport/screenshot-5.png", caption: "Designing the passport in Figma" },
        { src: "images/digital-product-passport/screenshot-6.png", caption: "Designing the passport in Figma" },
        { src: "images/digital-product-passport/screenshot-7.png", caption: "Designing the passport in Figma" },
      ],
      link: {
